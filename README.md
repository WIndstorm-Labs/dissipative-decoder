# Paper 5: The Dissipative Decoder — Experiments & Code
...
**[Windstorm-Institute/dissipative-decoder](https://github.com/Windstorm-Institute/dissipative-decoder)** — paper PDF, article HTML, Zenodo DOI

**Website article:** [windstorminstitute.org/articles/dissipative-decoder.html](https://windstorminstitute.org/articles/dissipative-decoder.html)

## What's in this repo

This Labs repository is **paper-only** — the experimental code from Paper 5's original development cycle (early 2026) was not migrated into a per-paper Labs repo. For the published manuscript, methods, figures, and Zenodo archive, see the canonical publication repo above. For the closest-known code from this era, see the archived [Windstorm-Labs/throughput-experiments](https://github.com/Windstorm-Labs/throughput-experiments) monorepo.
...
- **Discuss the paper itself** → [Comments on the website article](https://windstorminstitute.org/articles/dissipative-decoder.html#comments) or [Issues on the Institute repo](https://github.com/Windstorm-Institute/dissipative-decoder/issues)
